...
//    global $db;
                                    ...
                                    while($row = mysqli_fetch_array($result))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-danger btn-flat reject_requests" id="<?php echo $row['attendance_id']; ?>">Reject</button>
                                            </td>
                                        </tr>
                                        <?php
                                    }
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST">
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default btn-flat" data-dismiss="modal"><i class="fas fa-times"></i> Close</button>
                        <button type="submit" class="btn btn-danger btn-flat" name="reject_requests"><i class="fas fa-trash"></i> Reject</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            $('.reject_requests').click(function() {
